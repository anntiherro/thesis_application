...
await db.insert('tasks', {
  'id': 24,
  'topic_id': 2,
  'question': 'A table is 180 cm long, and a bench is 95 cm long. How much longer (in cm) is the table?',
  'options': null,
  'correct_answer': '85',
  'type': 'input',
});
...
await db.insert('tasks', {
  'id': 27,
  'topic_id': 2,
  'question': 'A watermelon weighs 3.7 kg, and a melon weighs 2.85 kg. What is their total mass (in g)?',
  'options': null,
  'correct_answer': '6550',
  'type': 'input',
});
...
await db.insert('tasks', {
  'id': 28,
  'topic_id': 2,
  'question': 'A box weighs 12 kg. With 4 identical books inside, it weighs 15.2 kg. What is the mass of one book (in g)?',
  'options': null,
  'correct_answer': '800',
  'type': 'input',
});
...
await db.insert('tasks', {
  'id': 211,
  'topic_id': 2,
  'question': 'A train departs at 14:35 and arrives at 17:10. How long does the trip take?',
  'options': jsonEncode(["2 h 35 min","3 h 35 min","2 h 15 min","1 h 55 min"]),
...
await db.insert('tasks', {
  'id': 212,
  'topic_id': 2,
  'question': 'A lesson starts at 8:15 and ends at 8:55. After a 20-minute break, when does the next lesson start?',
  'options': null,
  'correct_answer': '9:15',
  'type': 'input',
});
await db.insert('tasks', {
  'id': 31,
  'topic_id': 3,
  'question': 'Tom has 5 apples. He buys 3 more apples. Then he gives 2 apples to his friend. Write all calculation steps.',
  'options': null,
...
await db.insert('tasks', {
  'id': 32,
  'topic_id': 3,
  'question': 'Anna has 12 candies. She eats 4 candies. Then her friend gives her 7 more candies. Show all steps.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 33,
  'topic_id': 3,
  'question': 'A basket has 20 oranges. 5 are taken out, then 8 more are added. Show your calculations step by step.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 34,
  'topic_id': 3,
  'question': 'Lily has 30 pencils. She gives 10 to her friend and buys 12 more. Write each calculation step.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 35,
  'topic_id': 3,
  'question': 'Max has 3 boxes. Each box has 4 toys. How many toys in total? Then he gives 5 toys to his friend. Show all steps.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 36,
  'topic_id': 3,
  'question': 'A baker makes 6 cakes every day. How many cakes in 5 days? Then he sells 8 cakes. Show your calculations.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 37,
  'topic_id': 3,
  'question': 'There are 24 candies. They are shared equally among 6 children. Then 2 candies are added to each child. Write each step.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 38,
  'topic_id': 3,
  'question': 'A farmer has 8 rows of trees. Each row has 5 trees. Then 6 more trees are planted. Show all calculation steps.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 39,
  'topic_id': 3,
  'question': 'A train travels 60 km in 1 hour. How far will it travel in 3 hours? Then it stops for 1 hour. Calculate the total distance.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 310,
  'topic_id': 3,
  'question': 'A car drives 50 km per hour. It drives for 2 hours, then increases speed to 60 km per hour for 1 hour. How far did it go? Show each step.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 311,
  'topic_id': 3,
  'question': 'A pool is filled with 200 liters of water per hour. After 3 hours, another 150 liters are added. Calculate the total amount of water.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 312,
  'topic_id': 3,
  'question': 'John runs 4 km every day for 5 days. Then he rests 1 day. What is the total distance he ran? Show each calculation step.',
  'options': null,
  'correct_answer': jsonEncode([
...
await db.insert('tasks', {
  'id': 44,
  'topic_id': 4,
  'question': 'Classify the shapes {cube, sphere, cylinder}. Are these 2D or 3D shapes?',
  'options': null,
...
await db.insert('tasks', {
  ...
  'options': jsonEncode(["Max is an animal","Max is a dog","Max is a fish","Max is not an animal"]),
...
await db.insert('tasks', {
  ...
  'options': jsonEncode(["12 is divisible by 5","12 is divisible by 3","12 is divisible by 7","12 is divisible by 11"]),
